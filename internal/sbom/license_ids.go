// Code generated from SPDX License List v3.28.0; DO NOT EDIT.
// Sources: https://github.com/spdx/license-list-data/tree/v3.28.0/json
// Includes deprecated identifiers to recognize historical package metadata.
package sbom

import "strings"

var spdxLicenseIDs = licenseIDMap(`0BSD
3D-Slicer-1.0
AAL
ADSL
AFL-1.1
...
var spdxExceptionIDs = licenseIDMap(`389-exception
Asterisk-exception
...
func licenseIDMap(ids string) map[string]string {
