...
func TestValidIDAcceptsErrataWithColon(t *testing.T) {
	for _, id := range []string{"CVE-2024-1234", "GHSA-aaaa-bbbb-cccc", "ALPINE-13661", "RLSA-2019:0975", "ALSA-2024:1234", "SUSE-SU-2024:0001-1", "DW202402-001", "RUBYSEC-action_pack-2013-0156"} {
		if !validID(id) {
